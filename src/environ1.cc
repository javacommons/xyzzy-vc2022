...
int environ1::save_window_size = 1;
int environ1::save_window_snap_size = 0;
int environ1::save_window_position = 1;
int environ1::restore_window_size;
int environ1::restore_window_position;

int
environ1::load_geometry (int cmdshow, POINT *point, SIZE *size)
{
