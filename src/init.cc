...
init_app (HINSTANCE hinst, int passed_cmdshow, int &ole_initialized)
{
  ...
  POINT point;
  SIZE size;
  int cmdshow = environ1::load_geometry (passed_cmdshow, &point, &size);
  ...
  xsymbol_value (Vsave_window_size) = boole (environ1::save_window_size);
  xsymbol_value (Vsave_window_snap_size) = boole (environ1::save_window_snap_size);
  xsymbol_value (Vsave_window_position) = boole (environ1::save_window_position);
  xsymbol_value (Vrestore_window_size) = boole (environ1::restore_window_size);
  xsymbol_value (Vrestore_window_position) = boole (environ1::restore_window_position);
